...
export interface HalleyElement<P extends Attributes = any, T = string> {
  type: T
  props: P
  key: string
}
...
export type HalleyText = string | number
export type HalleyNode =
  | HalleyText
  | HalleyElement
  | HalleyNode[]
  | boolean
